...
import { useMantineTheme, getGradient, Container, Stack, Group, Text, Image, Paper, rem, createTheme, Loader, ColorSchemeScript, MantineProvider, Title, Divider, List, Button, Badge, Popover, ActionIcon, Modal, PasswordInput, Center, TextInput, Progress, Fieldset, PinInput, Box, ThemeIcon, CopyButton } from "@mantine/core";
...
import { IconBug, IconCheck, IconMoodSad, IconHome, IconArrowRight, IconX, IconSettingsBolt, IconServerCog, IconBolt, IconCircleCheck, IconChecks, IconPuzzle, IconQrcode, IconArrowBack, IconDatabaseStar, IconShieldBolt, IconEngine, IconRocket, IconLicense, IconHexagonLetterG, IconTag, IconNetwork, IconCalendarBolt, IconWorldWww, IconCube, IconCloudDownload, IconRefresh, IconCodeOff, IconRadarOff, IconSquareAsterisk, IconKey, IconCopy, IconLockSearch } from "@tabler/icons-react";
...
const PulseRadar = forwardRef(({ style, ...others }, ref) => /* @__PURE__ */ jsx(
  "svg",
  {
    ...others,
    ref,
    ...
    stroke: "#fff",
    children: /* @__PURE__ */ jsxs("g", { fill: "none", fillRule: "evenodd", transform: "translate(1 1)", strokeWidth: "2", children: [
      /* @__PURE__ */ jsxs("circle", { cx: "22", cy: "22", r: "6", strokeOpacity: "0", children: [
        /* @__PURE__ */ jsx(
          "animate",
          {
            attributeName: "r",
      ...
      /* @__PURE__ */ jsx("circle", { cx: "22", cy: "22", r: "8", children: /* @__PURE__ */ jsx(
        "animate",
        {
          attributeName: "r",
          begin: "0s",
...
const theme = createTheme({
  components: {
    ...
    Loader: Loader.extend({
      defaultProps: {
        loaders: { ...Loader.defaultLoaders, ring: PulseRadar },
        type: "ring"
      }
    })
  }
